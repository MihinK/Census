...
public class AddData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddImage = (Button) findViewById(R.id.editImageButton);
        buttonSubmit = (Button) findViewById(R.id.onClickAdd);
...
//           Toast.makeText(AddData.this,genderradioButton.getText(), Toast.LENGTH_SHORT).show();
    ...
    private void saveData() {
        ...
        myExampleList.add(new ExampleItem(encodedImage,line1,line2,line3));
