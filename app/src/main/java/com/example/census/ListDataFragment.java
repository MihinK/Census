 ...
 * Use the {@link ListDataFragment#newInstance} factory method to
...
public class ListDataFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button buttonListData = view.findViewById(R.id.buttonListData);
        //Button buttonListData = view.findViewById(R.id.buttonUploadCloud);
